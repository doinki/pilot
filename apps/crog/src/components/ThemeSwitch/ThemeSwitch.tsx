...
const ThemeSwitch = () => {
  ...
  return (
    <button
      ...
      aria-live="polite"
      className="h-8 w-8 rounded-full text-neutral-600 outline-offset-4 tap-highlight-transparent hover:text-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-300"
      title="Theme Switch"
      type="button"
      onClick={() => {
